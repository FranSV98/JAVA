...
public class Main {
  public static void main (String[] args){
    ...
    int[] listaNum = {5,8,2,4,6,8,4,2,7,6,4,22,4,32,3,4,1};   //ASI SE DECLARAN LISTASç
    ...
    */
    ...
    /*dia = 2;
    switch (dia){         //Se usa para elegir multiples opciones
      case 1:
    ...
    /*for (int i = 0 ; i < listaNum.length ; i++){      //RECORRER LISTA CON FOR
      System.out.print(listaNum[i] + " - ");
    }

    System.out.println();           //ORDENA LA LISTA
    ...
    while (i < listaNum.length){
      System.out.print(listaNum[i] + " - ");          // RECORRER LISTA CON WHILE
      i++;
    }
    System.out.println();*/
